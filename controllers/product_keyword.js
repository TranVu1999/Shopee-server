...
//         const score = productKeywordHelper.valuatedKeyword(listKeyword[i].keyword, keysearch);
...
module.exports = {
    ...
    */
    add: async function (req, res) {
        ...
        await productKeywordHelper.addNewProductKeyword(listKeyword, listProduct);
    ...
    */
    getListMatched: async function (req, res) {
        ...
        try {
            ...
            const listProdKeyword = productKeywordHelper.sortListKeyword(listProdKeyword_db, keyword).map(key => key.keyword);
